...
$client_id = '682663066236-il1t0nc2fqu29hhcdu491d8cqhp5jprg.apps.googleusercontent.com';
$client_secret = 'a4GC60PbQSNgFlBFGf3tp0ZP';
$redirect_uri = 'http://localhost:8081/site/envia.php';
...
if ($client->isAccessTokenExpired()) {
    $client->refreshToken("1/CrRiZnlomXIjhjdTotxhQ9zkgYrtsks6pB0WLOjnRrQMEudVrK5jSpoR30zcRFq6");
    //var_dump($client->getRefreshToken());
    //die("oi");
    //$authUrl = $client->createAuthUrl();
...
function enviarEmail($client, $texto){
    ...
    $strToMail = $texto["to"];
    $strSesFromEmail = 'crossbots@gmail.com';
...
$dadosEmail = array(
    "message" =>  " Email do(a) = " . trim($_POST['email']) . "<br/><br/>". $_POST['mensagem'],
